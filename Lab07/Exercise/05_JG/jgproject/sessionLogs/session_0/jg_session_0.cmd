...
# ----------------------------------------
# started   : 2026-04-27 11:41:12 CST
# hostname  : ee27.EEHPC
# pid       : 33681
# arguments : '-label' 'session_0' '-console' '//127.0.0.1:37776' '-style' 'windows' '-data' 'AAAAjHicY2RgYLCp////PwMYMFcBCQEGHwZfhiAGVyDpzxAGpOGA8QGUYcPIgAwYAxtQaAYGVphCmBImIOZg0GVIZkgBYgYGHoYshnQGPYYSIC8HzAcAU+INbA==' '-proj' '/RAID2/COURSE/2026_Spring/iclab/iclab053/Lab07_2026/Exercise/05_JG/jgproject/sessionLogs/session_0' '-init' '-hidden' '/RAID2/COURSE/2026_Spring/iclab/iclab053/Lab07_2026/Exercise/05_JG/jgproject/.tmp/.initCmds.tcl' 'jg.tcl'
check_cdc -init
clear -all
...
config_rtlds -rule -parameter  {ignore_convergence_from_complex_schemes = true}
