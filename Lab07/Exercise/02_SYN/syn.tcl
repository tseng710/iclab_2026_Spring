...
set OUTPUT_DLY [expr 0.5*$CYCLE1]
set OUTPUT_DLY_CLK2 [expr 0.5*$CYCLE2]
set OUTPUT_DLY_CLK3 [expr 0.5*$CYCLE3]
set INPUT_DLY_CLK3 [expr 0.5*$CYCLE3]
#======================================================
# (B) Read RTL Code
#======================================================
...
set clk2_ports [get_ports "*clk2*"]
set clk3_ports [get_ports "*clk3*"]

set non_clk1_ports [add_to_collection $clk2_ports $clk3_ports]
set clk1_outputs   [remove_from_collection [all_outputs] $non_clk1_ports]
...
set_output_delay  -max  $OUTPUT_DLY -clock clk1   $clk1_outputs ; # set_up time check 
set_output_delay  -min  0           -clock clk1   $clk1_outputs ; # hold   time check 


set clk3_outputs [filter_collection $clk3_ports "direction == out"]
set clk2_outputs [filter_collection $clk2_ports "direction == out"]

set_output_delay -max $OUTPUT_DLY_CLK3  -clock clk3 $clk3_outputs
set_output_delay -min 0                 -clock clk3 $clk3_outputs

set_output_delay -max $OUTPUT_DLY_CLK2  -clock clk2 $clk2_outputs
set_output_delay -min 0                 -clock clk2 $clk2_outputs

set clk3_in_ports [get_ports "*dram*_clk3*"]
set clk3_inputs [filter_collection $clk3_in_ports "direction == in"]
set_input_delay   -max  $INPUT_DLY_CLK3  -clock clk3   $clk3_inputs ;  # set_up time check 
set_input_delay   -min  0                -clock clk3   $clk3_inputs ;  # hold   time check 
