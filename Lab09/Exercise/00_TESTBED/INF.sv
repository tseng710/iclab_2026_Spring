interface INF();
    ...
    modport PATTERN(
        ...
        output rst_n, sel_action_valid, type_valid, mode_valid, date_valid, staff_valid, data_no_valid, restock_valid, D,
    ...
    modport DSS_inf(
        input rst_n, sel_action_valid, type_valid, mode_valid, date_valid, staff_valid, data_no_valid, restock_valid, D,
            AR_READY, R_VALID, R_RESP, R_DATA, AW_READY, W_READY, B_VALID, B_RESP,
