...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Sun Apr 05 18:45:30 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SRAM_128x128 : entity is TRUE;
...
architecture behavior of SRAM_128x128 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SRAM_128x128",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
