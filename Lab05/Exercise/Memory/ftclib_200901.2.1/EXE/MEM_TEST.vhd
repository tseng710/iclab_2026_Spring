...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Wed Apr 01 17:35:42 CST 2026
--
-- |-----------------------------------------------------------------------|
...
entity MEM_TEST is
   generic(
      ...
      tpd_CK_DO0_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO1_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO2_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO3_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO4_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO5_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO6_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO7_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO8_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO9_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO10_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO11_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO12_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO13_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO14_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO15_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO16_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO17_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO18_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO19_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO20_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO21_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO22_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO23_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO24_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO25_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO26_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO27_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO28_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO29_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO30_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      tpd_CK_DO31_posedge : VitalDelayType01 :=  (2.079 ns, 2.079 ns);
      ...
      tsetup_A9_CK_posedge_posedge    :  VitalDelayType := 0.648 ns;
      tsetup_A9_CK_negedge_posedge    :  VitalDelayType := 0.648 ns;
      ...
      tperiod_CK                      :  VitalDelayType := 2.588 ns;
...
attribute VITAL_LEVEL0 of MEM_TEST : entity is TRUE;
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/MEM_TEST",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
