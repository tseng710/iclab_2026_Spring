...
// wire [BURST_LEN-1:0]  awlen_w_inf_inst_1;
...
wire [BURST_LEN-1:0]   arlen_w_inf_inst_1;
...
// wire [BURST_LEN-1:0]  awlen_w_inf_inst_2;
...
wire [BURST_LEN-1:0]   arlen_w_inf_inst_2;
...
wire [BURST_LEN-1:0]  awlen_w_inf_data;
...
wire [BURST_LEN-1:0]   arlen_w_inf_data;
...
initial begin
  `ifdef RTL
    $fsdbDumpfile("DCCPU.fsdb");
    $fsdbDumpvars(0,"+mda");
  `endif
  `ifdef GATE
    $sdf_annotate("DCCPU_SYN.sdf", u_DCCPU);
    $fsdbDumpfile("DCCPU_SYN.fsdb");
    $fsdbDumpvars(0,"+mda");
  `endif
  `ifdef POST
