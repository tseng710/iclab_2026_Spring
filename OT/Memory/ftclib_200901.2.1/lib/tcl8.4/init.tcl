...
#
# RCS: @(#) $Id: init.tcl,v 1.1.1.1 2004/07/19 05:51:48 anchor Exp $
#
...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Mar 09, 2004
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.6.0 Linux/x86, Tue Mar 09 23:08:48 PST 2004
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {linux-ix86}
	buildtime,sec {1078902528}
	buildtime,fmt {Tue Mar 09 23:08:48 PST 2004}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.6.0 Linux/x86, Build 93925 @ Tue Mar 09 23:08:48 PST 2004 / normal}
    }
}

package provide {ActiveTcl} {8.4.6.0}
