...
# Created by write_sdc on Sun Apr 12 10:05:02 2026
...
set_input_delay -clock clk  -max 3  [get_ports {in_weight[2]}]
set_input_delay -clock clk  -min 0  [get_ports {in_weight[2]}]
set_input_delay -clock clk  -max 3  [get_ports {in_weight[1]}]
set_input_delay -clock clk  -min 0  [get_ports {in_weight[1]}]
set_input_delay -clock clk  -max 3  [get_ports {in_weight[0]}]
set_input_delay -clock clk  -min 0  [get_ports {in_weight[0]}]
set_input_delay -clock clk  -max 3  [get_ports out_mode]
...
set_output_delay -clock clk  -max 3  [get_ports out_code]
