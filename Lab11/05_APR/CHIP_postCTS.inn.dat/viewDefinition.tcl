...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SUMA180_4096X12_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SUMA180_4096X12_WC.lib]\
   -si\
...
create_delay_corner -name Delay_Conrner_min\
   -library_set lib_min\
   -rc_corner RC_Corner
...
create_analysis_view -name av_func_mode_min -constraint_mode func_mode -delay_corner Delay_Conrner_min -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
