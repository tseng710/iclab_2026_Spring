...
#  Generated on:      Tue May 26 16:27:12 2026
#  Design:            CHIP
...
#   clk (period 9.600ns) in timing_config func_mode([CHIP_cts.sdc])
create_ccopt_clock_tree -name clk -source clk -no_skew_group

# Clock period setting for source pin of clk
set_ccopt_property clock_period -pin clk 9.6
...
set_ccopt_property extracted_from_delay_corners -skew_group clk/func_mode {Delay_Corner_max Delay_Conrner_min}
