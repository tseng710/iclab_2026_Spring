...
set DESIGN "HT"
set CYCLE 10.0
# 你可以視情況把 CYCLE 往下壓來榨效能 (Spec允許最大到20.0，精確度到小數第一位)
...
# 🌟 Spec 20, 21: The input/output delay is set to 0.5*(clock period)
